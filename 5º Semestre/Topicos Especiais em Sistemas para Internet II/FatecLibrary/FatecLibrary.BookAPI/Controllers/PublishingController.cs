...
public class PublishingController : Controller
{
    ...
    [HttpGet("books")]
    public async Task<ActionResult<IEnumerable<PublishingDTO>>> GetPublishersBooks()
    {
    ...
    public async Task<ActionResult<PublishingDTO>> Get(int id)
    {
        ...
        if (publishingDTO == null) return NotFound("Publishing not found!");
        return Ok(publishingDTO);
    }
    ...
    {
        if (publishingDTO == null) return BadRequest("Data invalid");
